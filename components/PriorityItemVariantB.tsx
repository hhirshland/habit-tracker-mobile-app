...
/**
 * Variant B — Purple On-Brand
 * Design thesis: Completed items use the app's purple palette for a
 * cohesive, on-brand feel — soft lavender background, purple checkbox,
 * purple icons — unifying the completion state with Thrive's identity.
 */
...
export default function PriorityItemVariantB({
  habit,
  isCompleted,
  isSnoozed,
  isRequired,
