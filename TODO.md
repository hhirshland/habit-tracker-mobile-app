...
## Features
- [ ] Progress tab -- track your progress over time including habit completion rates, as well as progress in other relevant metrics (like weight, fitness PRs, etc).  Goal is to visualize and track how the habits drive results that matter to you
- [ ] Goals -- create goals that you want to achieve.  For example, goal weights (and how fast you want to get there), goal PRs like a 3 mile run time, or max benchpress, etc.
...
- [ ] Dark mode
- [ ] cl/ci automations to allow for auto builds.  When I push / commit to github, automatically make a build for the new beta so I can test.
